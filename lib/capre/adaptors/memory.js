...
var MasterMemoryAdaptor = function(callback) {
...
MasterMemoryAdaptor.prototype.getTypeInfo = function(type, callback) {
  var self = this
  process.nextTick(function() {
    if (self._store[type]) {
...
MasterMemoryAdaptor.prototype.flush = function(callback) {
